If you can't access RubyGems (mainly because IPV6 is blocking, but you do not want to block it) then install it from here, or find another repository. You need to UNTAR this folder so you can install it.
